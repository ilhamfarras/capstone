...
def signup():
	if request.method=="POST":
		session.clear()
		# Tambahkan validasi
		if not request.form.get("password") or not request.form.get("username") or not request.form.get("fullname"):
			return render_template("error.html", message="Please fill all fields!")
